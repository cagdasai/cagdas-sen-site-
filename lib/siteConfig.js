export const siteConfig = {
  ...
  description:
    "Çağdaş Şen — 20+ yıllık kariyer: Nebim, BulutkasaPOS, Fuodix, Setsis, PAX Türkiye. Perakende teknolojileri, ödeme sistemleri, iş geliştirme.",
  ...
  whatsapp: "", // E.164 formatında numara eklenince otomatik aktif olur. Örn: 905xxxxxxxxx
  nav: [
    ["Odak", "#focus", "Focus"],

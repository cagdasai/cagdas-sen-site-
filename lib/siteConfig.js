export const siteConfig = {
  ...
  // LinkedIn'de paylaşılan, gerçek saha videosu (JACK & JONES kasasız mağazacılık deneyimi)
  featuredVideo: {
    kicker: "Sahadan",
    title: "Kasasız mağazacılık, gerçek müşteri deneyimiyle.",
    description:
      "PAX A6650, Nebim Yazılım Mobil Store ve Param altyapısıyla hayata geçirilen yeni nesil kasasız mağazacılık deneyimini bizzat müşteri olarak yaşadım.",
    embedUrl: "https://www.linkedin.com/embed/feed/update/urn:li:activity:7402408275767451648",
  },

  // Sahadan paylaşımlar — LinkedIn gönderileri yan yana (Instagram bölümünün yerine)
  linkedinPosts: [

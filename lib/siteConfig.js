export const siteConfig = {
  ...
  nav: [
    ...
    ["Görüşler", "#insights", "Insights"],
    ["Deneyim", "#career", "Experience"],
    ["Hakkımda", "#nebim", "About"],
  ...
  caseStudies: [
    {
      number: "01",
      client: "Beymen",
      category: "Mağaza Deneyimi · Reyonda Ödeme",
      title: "Kasa artık ayrı bir durak değil.",
      description:
        "Ödeme deneyimini müşterinin bulunduğu noktaya taşıyan yapı; satış danışmanının müşteriyle reyonda kalmasını ve sürecin aynı noktada tamamlanmasını sağlıyor.",
    ...
    },
    {
      number: "02",
      client: "Kiğılı",
      category: "Entegrasyon · Merkezi Yönetim",
      title: "500 cihaz. Merkezi yönetim.",
      description:
        "Kasa ile ödeme terminali arasındaki manuel adımları sadeleştiren, cihaz ve uygulama yönetimini merkezi hale getiren entegre ödeme operasyonu.",
    ...
    },
    {
      number: "03",
      client: "MAD Parfüm",
      category: "Operasyon · Uzaktan Destek",
      title: "Teknik destek artık sahaya bağlı değil.",
      description:
        "Yaygın cihaz operasyonunda uzaktan erişim ve merkezi yönetim yaklaşımıyla fiziksel saha müdahalesine olan bağımlılığı azaltan destek modeli.",
      stat: "510 terminal",
  ...
  // Sahadan paylaşımlar — LinkedIn gönderileri yan yana
  linkedinSection: {
    kicker: "Sahadan",
    title: "Gerçek saha, gerçek projeler.",
    description:
      "LinkedIn'de paylaştığım saha görüntüleri ve projelerden kesitler.",
  },
  linkedinPosts: [
    { embedUrl: "https://www.linkedin.com/embed/feed/update/urn:li:activity:7402408275767451648" },
    { embedUrl: "https://www.linkedin.com/embed/feed/update/urn:li:activity:7500224457110765568" },
  ],
};
